...
export default strings = new LocalizedStrings({
    en: {
        ...
        select_text: 'Select',
        class_text: 'State-District*',
        section: 'Block-Village*',
        ...
        exam_date: 'Exam Date',
        test_date: 'Test Date',
        please_select_valid_section: 'Click below to type.',
        please_select_class: 'Click below to type.',
        please_select_section: 'Please select block-village',
